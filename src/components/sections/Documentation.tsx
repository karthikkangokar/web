...
const response = await bankfusion.accounts.getBalance({
...
const transfer = await bankfusion.payments.createTransfer({
...
const statement = await bankfusion.accounts.getStatement({
  accountNumber: '1234567890',
  bankCode: 'AXIS',
  fromDate: '2023-01-01',
  toDate: '2023-01-31',
...
const reconciliation = await bankfusion.reconciliation.process({
  accountNumber: '1234567890',
  bankCode: 'FEDERAL',
  fromDate: '2023-01-01',
  toDate: '2023-01-31',
    ...
    <section id="documentation" className="section bg-white">
      <div className="container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 text-slate-900">API Features</h3>
            ...
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-6 border border-primary-200">
              <h4 className="text-lg font-semibold mb-4 text-slate-900">Getting Started</h4>
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 text-slate-900">Code Examples</h3>
